const DesctopBG = () => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 274 568">
			<rect width="100%" height="100%" fill="#483EFF" rx="10" />
			<mask
				id="a"
				width="100%"
				height="100%"
