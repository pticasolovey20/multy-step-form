	...
	return (
		<div className="flex flex-col gap-1 md:gap-2">
			<div className="flex items-center justify-between text-sm md:text-base leading-none">
				<label htmlFor={id} className="text-primary-marine-blue font-medium sm:font-semibold tracking-tighter">
					{label}
				</label>
			...
			<input
				className={classNames(
					"px-4 py-2.5 rounded-[4px] md:rounded-lg border border-neutral-light-gray",
