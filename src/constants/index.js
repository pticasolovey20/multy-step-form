...
export const addons = [
	{ name: "Online service", keyCheck: "onlineService", description: "Access to multiplayer games", price: 1 },
	{ name: "Larger storage", keyCheck: "largerStorage", description: "Extra 1TB of cloud save", price: 2 },
	{
		name: "Customizable Profile",
		keyCheck: "customizableProfile",
